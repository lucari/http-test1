...
```
$ s2i build https://github.com/openshift/httpd-test1 centos/httpd-24-centos7 myhttpdimage
...
`$ oc new-app centos/httpd-24-centos7~https://github.com/openshift/httpd-test1`
